...
import {
  ...
  spendAttack,
} from '../js/state.js?v=20260904';
import { resolveManeuver } from '../js/combat.js?v=20260904';
import { bestExistingAttack, findCombinedLethal } from '../js/bot_ai.js?v=20260904';
