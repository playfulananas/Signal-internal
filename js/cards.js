...
export const CARDS = [
  // ── UNITS — INFANTRY (22) ────────────────────────────────────────────────
  { id:"I1",  name:"Rifle Squad",         cls:"Infantry", rarity:"Common", type:"unit", cost:1, copies:2, keyword:null, n:5, e:4, s:2, w:2, ability:null },
  ...
  { id:"I6",  name:"Shield Bearers",      cls:"Infantry", rarity:"Common", type:"unit", cost:1, copies:2, keyword:"Guard", n:2, e:4, s:3, w:1, ability:null },
  ...
  { id:"I9",  name:"Motivator",           cls:"Infantry", rarity:"Common", type:"unit", cost:2, copies:2, keyword:"Inspire", n:5, e:4, s:3, w:4, ability:"Inspire: adjacent friendly Units get +1 all sides while this Unit is on the battlefield." },
  ...
  { id:"I12", name:"Assault Trooper",     cls:"Infantry", rarity:"Common", type:"unit", cost:2, copies:2, keyword:"Rally", n:4, e:2, s:4, w:4, ability:"Rally: draw 1 card." },
  { id:"I13", name:"Combat Engager",      cls:"Infantry", rarity:"Common", type:"unit", cost:3, copies:2, keyword:"Rally", n:4, e:5, s:5, w:3, ability:"Rally: a random other friendly Infantry gains +1 all sides permanently." },
  ...
  { id:"I18", name:"Last Stand Soldier",  cls:"Infantry", rarity:"Common", type:"unit", cost:2, copies:2, keyword:"Last Stand", n:2, e:4, s:4, w:3, ability:"Last Stand: draw 1 card." },
  ...
  { id:"I20", name:"Shock Trooper",       cls:"Infantry", rarity:"Common", type:"unit", cost:4, copies:2, keyword:"Double Attack", n:5, e:5, s:3, w:4, ability:null },
  ...
  { id:"I22", name:"Field Commander",     cls:"Infantry", rarity:"Common", type:"unit", cost:3, copies:2, keyword:["Guard","Last Stand"], n:4, e:2, s:3, w:5, ability:"Last Stand: adjacent friendly Infantry gain +1 all sides until end of turn." },
  ...
  // ── UNITS — ARTILLERY (14) ───────────────────────────────────────────────
  { id:"AR40", name:"Ranging Section",       cls:"Artillery", rarity:"Common", type:"unit", cost:1, copies:2, keyword:null, n:3, e:2, s:6, w:2, ability:null },
  ...
  { id:"AR43", name:"Field Howitzer",        cls:"Artillery", rarity:"Common", type:"unit", cost:2, copies:2, keyword:"Bombard", n:1, e:2, s:2, w:7, ability:null },
  { id:"AR44", name:"Heavy Howitzer",        cls:"Artillery", rarity:"Common", type:"unit", cost:4, copies:2, keyword:"Bombard", n:3, e:3, s:9, w:4, ability:null },
  { id:"AR45", name:"Long-Range Battery",    cls:"Artillery", rarity:"Common", type:"unit", cost:5, copies:2, keyword:"Bombard", n:4, e:10, s:5, w:5, ability:null },
  { id:"AR46", name:"Mortar Battery",        cls:"Artillery", rarity:"Common", type:"unit", cost:2, copies:2, keyword:"Blast", n:3, e:6, s:2, w:2, ability:"Blast: on a successful Hit, also Hit enemy Units directly left/right of the target relative to attack direction." },
  { id:"AR47", name:"Siege Gun",             cls:"Artillery", rarity:"Common", type:"unit", cost:4, copies:2, keyword:"Blast", n:3, e:4, s:8, w:3, ability:"Blast: on a successful Hit, also Hit enemy Units directly left/right of the target relative to attack direction." },
  { id:"AR48", name:"Rocket Battery",        cls:"Artillery", rarity:"Common", type:"unit", cost:3, copies:2, keyword:"Barrage", n:2, e:2, s:4, w:6, ability:"Barrage: on a successful Hit, also Hit enemy Units farther along the forward attack ray beyond the target." },
  ...
  { id:"AR53", name:"Grand Battery",         cls:"Artillery", rarity:"Rare",   type:"unit", cost:5, copies:1, keyword:["Bombard","Barrage","Blast"], n:9, e:2, s:2, w:2, ability:"Combines ranged, forward-ray, and side-splash Hits on a single successful attack; primary Hit resolves first." },
  ...
  { id:"C30", name:"Artillery Barrage",  cls:"Artillery", rarity:"Common", type:"command", cost:2, copies:2, effect:"Give 1 friendly Artillery Barrage and +1 to all sides until end of turn." },
  { id:"C31", name:"Target Coordinates", cls:"Artillery", rarity:"Common", type:"command", cost:1, copies:2, effect:"Give 1 friendly Artillery Precision and +1 to all sides until end of turn." },
  ...
  // ── HEROES (25) ───────────────────────────────────────────────────────────
  { id:"H01", name:"Quartermaster General",         rarity:"Common", type:"hero", implemented:true, scope:"board",  powerType:"active",  activeCost:2,    ability:"Look at 3 random cards from your deck, choose 1 to put into your hand; the others remain in the deck." },
  ...
  { id:"H04", name:"Objective Marshal",             rarity:"Common", type:"hero", implemented:true, scope:"board",   powerType:"passive", activeCost:null, ability:"The first friendly Unit you play each turn adjacent to an Objective gets +1 all sides until your next turn." },
  ...
  { id:"H08", name:"Infantry Commander",            rarity:"Common", type:"hero", implemented:true, scope:"column", powerType:"passive", activeCost:null, ability:"The first Infantry played in this Hero's column each turn gets +1 all sides until your next turn." },
  ...
  { id:"H17", name:"HQ Assault Commander",          rarity:"Common", type:"hero", implemented:true, scope:"board",  powerType:"active",  activeCost:2,    ability:"Deal 2 damage to the enemy HQ." },
  { id:"H18", name:"Artillery Commander",           rarity:"Common", type:"hero", implemented:true, scope:"column", powerType:"active",  activeCost:1,    ability:"Give 1 friendly Artillery in this Hero's column +1 to all sides and Blast until end of turn." },
  ...
  { id:"H25", name:"Chief Aircraft Engineer",       rarity:"Common", type:"hero", implemented:true, scope:"board",  powerType:"active",  activeCost:4,    ability:"Craft: generate 3 candidate Aircraft (one stats package + one of Bombard/Double Attack/Armor + one drawback each), choose 1 to add to hand (costs 1 Fuel to play, no copy-limit accounting). After each activation, this ability's cost reduces by 1 for the rest of the match, to a minimum of 1." },
];
